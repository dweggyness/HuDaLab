...
const rCartesianBaseArr = [
  ...
  { node: "B4", x: 15, y: 8, width: 4, height: 9, color: "teal" },
...
const getTreeArr = (settings) => {
  ...
  for (const obj of settings) {
    if (obj.node === undefined) {
      ...
      if (obj.hide) {
        arr = arr.filter(arrObj => arrObj.node !== obj.node);
      } else {
...
const stepsArr = [
  ...
  { tree:[],   
    cartesian:[], 
    arrow: [],
    stepText: `We want to remove Object Q from the R-Tree.`,
    drawQTree: true,
  },
  // step 2
  { tree:[],   
    cartesian:[], 
    arrow: [],
    stepText: `First, we invoke FindLeaf to find the node containing Q.`,
    drawQTree: true,
  },
  // step 3
  { tree:[{ node: "R1", fill: "yellow" }], 
    ...
    arrow: [],
    stepText: `Start from the root, check if Object Q is within the bounding rectangle in R1. Q is not in R1.`,
    drawQTree: true,
  },
  // step 4
  { tree:[{ node: "R2", fill: "yellow" }], 
    ...
    arrow: [],
    stepText: `Check if Object Q is within the bounding rectangle in R2. Q is within R2.`,
    drawQTree: true,
  },
  // step 5
  { tree:[{ node: "R2", fill: "palegreen" }, { node: "B3", fill: "yellow" }], 
    cartesian:[
      { node: "B3", highlight: "true" },  
    ], 
    arrow: [{ node: "R2", highlight: true }],
    stepText: `Pick R2 as the next node, and continue searching from there. 
    Check if Object Q is within the bounding rectangle of B3.`,
    drawQTree: true,
  },
  // step 6
  { tree:[{ node: "R2", fill: "palegreen" }, { node: "B4", fill: "yellow" }], 
    cartesian:[
      { node: "B4", highlight: "true" },  
    ], 
    arrow: [{ node: "R2", highlight: true }],
    stepText: `As Object Q is not in B3, check if Q is in B4.`,
    drawQTree: true,
  },
  // step 7
  { tree:[{ node: "R2", fill: "palegreen" }, { node: "B4", fill: "palegreen" }], 
    cartesian:[
      { node: "B4", highlight: "true" },  
    ], 
    arrow: [{ node: "R2", highlight: true }, { node: "B4", highlight: true }],
    stepText: `Object Q is in B4. Pick B4 as the next node.`,
    drawQTree: true,
  },
  // step 8
  { tree:[{ node: "R2", fill: "palegreen" }, { node: "Q", fill: "yellow" }, { node: "B4", fill: "palegreen" }], 
    cartesian:[
      { node: "B4", highlight: "true" },  
      { node: "Q", highlight: "true" },  
    ], 
    arrow: [{ node: "R2", highlight: true }, { node: "B4", highlight: true }],
    stepText: `As B4 is a Leaf node, check each entry to see if it matches Q. We return Q as Q is found within this node.`,
    drawQTree: true,
  },
  // step 9
  { tree:[{ node: "R2", fill: "palegreen" }, { node: "Q", hide: true }, { node: "B4", fill: "palegreen" }], 
    cartesian:[
      { node: "B4", highlight: "true" },  
      { node: "Q", hide: true }, 
    ], 
    arrow: [{ node: "R2", highlight: true }, { node: "B4", highlight: true }],
    stepText: `Remove Object Q from B4.`,
  },
  // step 10
  { tree:[{ node: "R2", fill: "palegreen" }, { node: "Q", hide: true }, { node: "B4", fill: "yellow" }], 
    cartesian:[
      { node: "B4", color: "none" },  
      { node: "Q", hide: true }, 
    ], 
    arrow: [{ node: "R2", highlight: true }],
    stepText: `Invoke CondenseTree on B4.`,
  },
  // step 11
  { tree:[{ node: "R2", fill: "palegreen" }, { node: "Q", hide: true }, { node: "B4", fill: "yellow" }], 
    cartesian:[
    ...
    arrow: [{ node: "R2", highlight: true }],
    stepText: `Recalculate the bounding rectangle for B4.`,
  },
  // step 12
  { tree:[{ node: "R2", fill: "yellow" }, { node: "Q", hide: true }], 
    cartesian:[
      { node: "B4", height: 7 },  
      { node: "Q", hide: true }, 
    ], 
    arrow: [{ node: "R2", highlight: true }],
    stepText: `CondenseTree is then propagated up the tree, R2.`,
  },
  // step 13
  { tree:[{ node: "R2", fill: "yellow" }, { node: "Q", hide: true }], 
    cartesian:[
    ...
    arrow: [{ node: "R2", highlight: true }],
    stepText: `Recalculate the bounding rectangle for R2.`,
  },
  // step 14
  { tree:[{ node: "Q", hide: true }], 
    cartesian:[
      { node: "B4", height: 7 },  
      { node: "Q", hide: true }, 
    ], 
    arrow: [],
    stepText: `As R2's parent is the root, then CondenseTree is complete. Deletion of Object Q is complete.`,
  },
]
